...
async function handleData() {
  ...
  // const assistidasRef = users.aulasAssistidas.map(v => v.ref)
...
export default function Test() {
  ...
  return (
    <div className="flex w-screen justify-center items-center bg-zinc-900">
      {isLoading ? (
        <div role="status">
          <svg
            aria-hidden="true"
        ...
        <div>
          ...
          {userData && (
            <div>
              ...
              <p>{userData.email}</p>
              <ul>
                {userData.attendedClasses.map((a, i) => (
                  <li key={i}>
                    {a.id} || {a.attendedDate}
                  </li>
                ))}
